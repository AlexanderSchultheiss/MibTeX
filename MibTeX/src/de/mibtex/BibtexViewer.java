...
public class BibtexViewer {
    ...
    public BibtexViewer(String format) throws Exception {
        ...
        switch (format.toUpperCase()) {
            case "CSV":
                exporter = new ExportCSV(BibtexViewer.BIBTEX_DIR, "literature-for-reading.bib");
                break;
            case "JSON":
                exporter = new ExportJSON(BibtexViewer.BIBTEX_DIR, "literature-for-reading.bib");
                break;
            case "CITATIONS":
                exporter = new ExportCitations(BibtexViewer.BIBTEX_DIR, "literature-for-reading.bib");
                break;
            case "CONFLICTS":
                exporter = new ExportConflicts(BibtexViewer.BIBTEX_DIR, "literature-for-reading.bib");
                break;
            case "CLASSIFICATION":
                exporter = new ExportClassification(BibtexViewer.BIBTEX_DIR, "literature-for-reading.bib");
                break;
            case "SAMPLING":
                exporter = new ExportSampling(BibtexViewer.BIBTEX_DIR, "literature-for-reading.bib");
                break;
            case "SAMPLING LATEX":
                exporter = new ExportSamplingLatex(BibtexViewer.BIBTEX_DIR, "literature-for-reading.bib");
                break;
            case "HTML_NEW":
                exporter = new ExportNewHTML(BibtexViewer.BIBTEX_DIR, "literature-for-reading.bib");
                break;
            case "FIND_PDFS":
                exporter = new ExportFindPDFs(BibtexViewer.BIBTEX_DIR, "literature-for-reading.bib");
                break;
            case "TYPO3":
                exporter = new ExportTypo3Bibtex(BibtexViewer.BIBTEX_DIR, "literature-for-reading.bib");
                break;
            case "HTML":
            default:
                exporter = new ExportHTML(BibtexViewer.BIBTEX_DIR, "literature-for-reading.bib");
        }
        if (cleanOutputDir) {
